...
After you've gotten your geocoder database set up, run <pre>./manage.py
syncdb</pre> and then <pre>./manage.py dbshell --database <yourgeocoder></pre>,
...
Next, you'll want to add 'postgis_geocoder' to your <pre>INSTALLED_APPS</pre> list.
Add a new setting, <pre>GEOCODER_ALIAS</pre>, with a value of your database alias
(again, 'geocoder'  unless you opted for something different), run
<pre>syncdb</pre> again and you're done modifying settings.
...
Finally, this project draws on several core features of Django that have
enabled sane defaults, deep querying and minimal repetition throughout.
Thanks as always to those who contribute to its codebase and success.